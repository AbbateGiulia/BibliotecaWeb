 ...
 */
@WebServlet("/visualizza/VisualizzaAutoreServlet")
public class VisualizzaAutoreServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Autore autoreShow =MyServiceFactory.getAutoreServiceInstance()
					.caricaSingoloElemento(Long.parseLong(idInputParam));
			request.setAttribute("autoreShow", autoreShow);
		 ...
		 request.getRequestDispatcher("/jsp/autore/showautore.jsp").forward(request, response);
	}
