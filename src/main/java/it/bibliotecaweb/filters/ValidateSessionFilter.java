...
private String contesto;
	...
	public void init(FilterConfig fConfig) throws ServletException {
		contesto = fConfig.getServletContext().getContextPath()+ "/jsp"; //configuro il path che dovrà seguire la catena di filtri
	}
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(percorso.equals("/bibliotecaweb/jsp/") || percorso.equals("/bibliotecaweb/") || percorso.equals("/bibliotecaweb/jsp") || percorso.equals("/bibliotecaweb/ExecuteLoginServlet") || percorso.equals("/biblioteca/ExecuteLogoutServlet")) { //entra qui se il filtro atterra su queste due servlet
