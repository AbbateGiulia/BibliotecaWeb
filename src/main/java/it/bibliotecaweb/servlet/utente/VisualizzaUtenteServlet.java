...
public class VisualizzaUtenteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Utente utenteShow =MyServiceFactory.getUtenteServiceInstance()
					.caricaSingoloElemento(Long.parseLong(idInputParam));
			request.setAttribute("utenteShow", utenteShow);
		 ...
		 request.getRequestDispatcher("/jsp/utente/showutente.jsp").forward(request, response);
	}
