	  ...
	  <div class="jumbotron" >
	   ...
	   <!--    <p><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/PrepareLoginServlet" role="button">Login &raquo;</a></p>  	     -->
	       <p><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/cerca/PrepareSearchLibroServlet" role="button">Cerca Libro &raquo;</a></p>
	        <p><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/cerca/PrepareSearchAutoreServlet" role="button">Cerca Autore &raquo;</a></p>
	        <c:if test = "${sessionScope.isAdmin ==true }">
	        <p><a class="btn btn-primary btn-lg" href="${pageContext.request.contextPath}/admin/PrepareSearchUtenteServlet" role="button">Cerca Utente &raquo;</a></p>
	    	</c:if>
